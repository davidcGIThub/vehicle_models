...
start_position = path_location_arr[:,0]
...
path_length = np.sum(np.linalg.norm(path_location_arr[:,1:] - path_location_arr[:,0:-1],2,0))
print("path_length: " , path_length)

distance_travelled = np.sum(np.linalg.norm(vehicle_path_data.location_data[:,1:] - vehicle_path_data.location_data[:,0:-1],2,0))
print("path_length: " , distance_travelled)

print("traversal time: " , time_arr[-1])
