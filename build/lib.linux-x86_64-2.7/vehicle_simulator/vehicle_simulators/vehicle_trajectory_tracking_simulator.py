...
class VehicleTrajectoryTrackingSimulator:
    ...
    def plot_simulation_dynamics(self, vehicle_motion_data: VehicleMotionData,
        ...
        axs[1].plot(path_time_data, path_time_data*0 + max_velocity, color='k', label="max vel")
        axs[1].plot(path_time_data, path_velocity_magnitude_data, color = 'tab:blue', label= "des vel")
        axs[1].plot(true_time_data, true_velocity_magnitude, color = 'tab:olive', label= "true vel",linestyle="--")   
        axs[1].set_ylabel("velocity \n (m/s)")
        axs[2].plot(path_time_data, path_time_data*0 + max_acceleration, color='k', label="max accel")
        ...
        axs[2].plot(true_time_data, true_long_accel_mag, color = 'tab:olive', label =  "true vel dot",linestyle="--")
        axs[2].set_ylabel("acceleration \n (m/s^2)")
        axs[3].plot(path_time_data,path_time_data*0 + max_turn_value, color='k', label="max " + turn_legend_label)
        axs[3].plot(path_time_data,path_turn_data,color='tab:blue', label="des " + turn_legend_label)
        if vehicle_type == "bike":
            axs[3].plot(true_time_data,vehicle_turn_data,color='tab:olive', label= "body " + turn_legend_label)
        else:
            axs[3].plot(true_time_data,true_turn_data,color='tab:olive', label= "true " + turn_legend_label ,linestyle="--")
